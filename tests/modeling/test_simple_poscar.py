...
class TestSimplePoscar(unittest.TestCase):
    ...
    def test_compare_poscar_different_symbols(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertFalse(
                flag, "Structures with different symbol counts should not be equal"
            )
...
"""
            ...
            self.assertEqual(
                ...
                "Returned file path should match expected path",
            )
...
"""
            ...
            merged_file = SimplePoscar.merge_poscar(
                [poscar1_file, poscar2_file, poscar3_file], temp_path
            )
    ...
    def test_separate_poscar_by_note(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertIn(
                group1_file, separated_files, "Group 1a-Au file should be in returned list"
            )
            self.assertIn(
                group2_file, separated_files, "Group 3c-Cu file should be in returned list"
            )
    ...
    def test_separate_poscar_by_symbol(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            separated_files = SimplePoscar.separate_poscar(
                poscar1_file, temp_path, key="symbol"
            )
