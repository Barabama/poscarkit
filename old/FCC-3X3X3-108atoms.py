...
############################################ 基础配置信息 #####################################################
workPath = 'E:\Desktop\FCC-BCC-HCP-POSCAR-TemplatePython\FCC\FCC-3X3X3-108atoms'
...
poscarBases = np.array([
    ...
    [0.00000000,10.50000000,0.00000000],
...
## 1a
df1 = pd.read_excel(f'{workPath}\FCC-原子位置模板{strOcc}.xlsx',sheet_name=0)
...
## 3c
df3 = pd.read_excel(f'{workPath}\FCC-原子位置模板{strOcc}.xlsx',sheet_name=1)
