...
############################################ 基础配置信息 #####################################################
workPath = 'E:\Desktop\FCC-BCC-HCP-POSCAR-TemplatePython\HCP\HCP-2X2X2-64atoms'
...
poscarBases = np.array([
    [10.6095161438,0.00000000,0.00000000],
    [-5.3047580719,9.1881105024,0.00000000],
    [0.00000000,0.00000000,8.4832658768]
])
...
## 2c
df1 = pd.read_excel(f'{workPath}\{sublatticeName}-原子位置模板{strOcc}.xlsx',sheet_name=0)
...
## 6h
df3 = pd.read_excel(f'{workPath}\{sublatticeName}-原子位置模板{strOcc}.xlsx',sheet_name=1)
